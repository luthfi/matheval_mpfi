...
/********************************** mpfi eval ********************/
/* We can't separate this from matheval.c because Evaluator is
declared in .c here instead of .h :^(
*/
double
evaluator_mpfi_evaluate(void *evaluator, mpfi_t f, mpfi_var* vars)
{
  /* construct mpfi function f using tree represention of function. */
  node_mpfi_construct(((Evaluator *) evaluator)->root, f, vars);
}
